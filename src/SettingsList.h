...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr,
  ...
  static const std::vector<SettingInfo> baseList = [] {
    ...
    sleepScreenValues[CrossPointSettings::VANNHANSO] = StrId::STR_VANNHANSO;
    sleepScreenValues[CrossPointSettings::TRANSPARENT_CUSTOM] = StrId::STR_TRANSPARENT;
    sleepScreenValues[CrossPointSettings::DICTIONARY_REVIEW] = StrId::STR_DICTIONARY_REVIEW_SLEEP;
    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_VANNHANSO_FONT_SIZE, &CrossPointSettings::vanNhanSoFontSize,
                          {StrId::STR_VANNHANSO_FONT_STANDARD, StrId::STR_VANNHANSO_FONT_LARGE}, "vanNhanSoFontSize",
                          StrId::STR_CAT_DISPLAY),
        SettingInfo::Enum(StrId::STR_VANNHANSO_VOCABULARY_LEVEL, &CrossPointSettings::vanNhanSoVocabularyLevel,
                          {StrId::STR_VANNHANSO_VOCAB_B1, StrId::STR_VANNHANSO_VOCAB_B2, StrId::STR_VANNHANSO_VOCAB_C1,
                           StrId::STR_VANNHANSO_VOCAB_C2, StrId::STR_VANNHANSO_VOCAB_MIXED},
                          "vanNhanSoVocabularyLevel", StrId::STR_CAT_DISPLAY),
        SettingInfo::Enum(StrId::STR_VANNHANSO_WEATHER_LOCATION, &CrossPointSettings::vanNhanSoWeatherLocation,
        ...
        SettingInfo::Toggle(StrId::STR_TRACK_READING_STATS, &CrossPointSettings::trackReadingStats, "trackReadingStats",
                            StrId::STR_CAT_SYSTEM),
        SettingInfo::Value(StrId::STR_READING_IDLE_THRESHOLD, &CrossPointSettings::readingIdleTimeThresholdUnits,
                           {CrossPointSettings::MIN_READING_IDLE_TIME_THRESHOLD_UNITS,
                            CrossPointSettings::MAX_READING_IDLE_TIME_THRESHOLD_UNITS, 3},
