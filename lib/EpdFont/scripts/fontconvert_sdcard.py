...
INTERVAL_PRESETS = {
    ...
    "vns-symbols": [(0x2190, 0x2190), (0x2192, 0x2192),
                    (0x25A0, 0x25A1), (0x25C6, 0x25C7), (0x25CB, 0x25CB),
                    (0x25CF, 0x25CF), (0x2605, 0x2606), (0x2661, 0x2661),
                    (0x2665, 0x2665), (0x2713, 0x2713), (0x2717, 0x2717)],
...
def rasterize_font_style(fontfile, size, intervals, style_id=0, force_autohint=False,
    ...
    for i_start, i_end in intervals:
        ...
        for code_point in range(i_start, i_end + 1):
            ...
            has_fallback = any(fallback_face.get_char_index(code_point) != 0 for fallback_face in fallback_faces)
